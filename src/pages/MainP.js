...
function Main() {
  ...
  const {
   ...
   async function UpdateState2(message) {
                      ...
                      return (
                        ...
                        >
                          <button
                            onClick={() => {
                              navigate("/edit");
                              console.log(cell.row.original.saksnummer);
                              console.log(cell.row.original.name);
                              setGlobalState({
                                glb_saksnummer: cell.row.original.saksnummer,
                                glb_name: cell.row.original.name,
                                glb_user: globalState.glb_user,
                              });
                            }}
                          >
                            {" "}
